...
namespace LightWiki.Data.Migrations
{
    ...
    [Migration("20220218152043_AddUserInfo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LightWiki.Domain.Models.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("OwnerType")
                        .HasDatabaseName("ix_images_owner_type");
            ...
            modelBuilder.Entity("LightWiki.Domain.Models.UserInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_user_infos_user_id");
            ...
            modelBuilder.Entity("LightWiki.Domain.Models.UserInfo", b =>
                {
                    b.HasOne("LightWiki.Domain.Models.User", "User")
                        .WithOne("UserInfo")
                        .HasForeignKey("LightWiki.Domain.Models.UserInfo", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_infos_users_user_id");
